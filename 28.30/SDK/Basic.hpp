...
namespace Offsets
{
	constexpr int32 GObjects          = 0x1176AB00;
	constexpr int32 AppendString      = 0x01065210;
	constexpr int32 GNames            = 0x119692C0;
	constexpr int32 GWorld            = 0x11791DF8;
	constexpr int32 ProcessEvent      = 0x03D1D36C;
...
namespace InSDKUtils
{
	...
	inline auto CallGameFunction(FuncType Function, ParamTypes&&... Args)
		-> decltype(Function(std::forward<ParamTypes>(Args)...))
	{
...
struct StringLiteral
{
	...
	constexpr StringLiteral(const char(&String)[Len])
	{
...
static_assert(sizeof(FField) == 0x000028, "Wrong size on FField");
...
static_assert(offsetof(FField, ObjFlags) == 0x000024, "Member 'FField::ObjFlags' has a wrong offset!");
...
static_assert(sizeof(FProperty) == 0x000068, "Wrong size on FProperty");
static_assert(offsetof(FProperty, ArrayDim) == 0x000028, "Member 'FProperty::ArrayDim' has a wrong offset!");
static_assert(offsetof(FProperty, ElementSize) == 0x00002C, "Member 'FProperty::ElementSize' has a wrong offset!");
static_assert(offsetof(FProperty, PropertyFlags) == 0x000030, "Member 'FProperty::PropertyFlags' has a wrong offset!");
static_assert(offsetof(FProperty, Offset) == 0x00003C, "Member 'FProperty::Offset' has a wrong offset!");
...
static_assert(sizeof(FByteProperty) == 0x000070, "Wrong size on FByteProperty");
static_assert(offsetof(FByteProperty, Enum) == 0x000068, "Member 'FByteProperty::Enum' has a wrong offset!");
...
static_assert(sizeof(FBoolProperty) == 0x000070, "Wrong size on FBoolProperty");
static_assert(offsetof(FBoolProperty, FieldSize) == 0x000068, "Member 'FBoolProperty::FieldSize' has a wrong offset!");
static_assert(offsetof(FBoolProperty, ByteOffset) == 0x000069, "Member 'FBoolProperty::ByteOffset' has a wrong offset!");
static_assert(offsetof(FBoolProperty, ByteMask) == 0x00006A, "Member 'FBoolProperty::ByteMask' has a wrong offset!");
static_assert(offsetof(FBoolProperty, FieldMask) == 0x00006B, "Member 'FBoolProperty::FieldMask' has a wrong offset!");
...
static_assert(sizeof(FObjectPropertyBase) == 0x000070, "Wrong size on FObjectPropertyBase");
static_assert(offsetof(FObjectPropertyBase, PropertyClass) == 0x000068, "Member 'FObjectPropertyBase::PropertyClass' has a wrong offset!");
...
static_assert(sizeof(FClassProperty) == 0x000078, "Wrong size on FClassProperty");
static_assert(offsetof(FClassProperty, MetaClass) == 0x000070, "Member 'FClassProperty::MetaClass' has a wrong offset!");
...
static_assert(sizeof(FStructProperty) == 0x000070, "Wrong size on FStructProperty");
static_assert(offsetof(FStructProperty, Struct) == 0x000068, "Member 'FStructProperty::Struct' has a wrong offset!");
...
static_assert(sizeof(FDelegateProperty) == 0x000070, "Wrong size on FDelegateProperty");
static_assert(offsetof(FDelegateProperty, SignatureFunction) == 0x000068, "Member 'FDelegateProperty::SignatureFunction' has a wrong offset!");
...
static_assert(sizeof(FMapProperty) == 0x000078, "Wrong size on FMapProperty");
static_assert(offsetof(FMapProperty, KeyProperty) == 0x000068, "Member 'FMapProperty::KeyProperty' has a wrong offset!");
static_assert(offsetof(FMapProperty, ValueProperty) == 0x000070, "Member 'FMapProperty::ValueProperty' has a wrong offset!");
...
static_assert(sizeof(FSetProperty) == 0x000070, "Wrong size on FSetProperty");
static_assert(offsetof(FSetProperty, ElementProperty) == 0x000068, "Member 'FSetProperty::ElementProperty' has a wrong offset!");
...
static_assert(sizeof(FEnumProperty) == 0x000078, "Wrong size on FEnumProperty");
static_assert(offsetof(FEnumProperty, UnderlayingProperty) == 0x000068, "Member 'FEnumProperty::UnderlayingProperty' has a wrong offset!");
static_assert(offsetof(FEnumProperty, Enum) == 0x000070, "Member 'FEnumProperty::Enum' has a wrong offset!");
...
static_assert(sizeof(FFieldPathProperty) == 0x000070, "Wrong size on FFieldPathProperty");
static_assert(offsetof(FFieldPathProperty, FieldClass) == 0x000068, "Member 'FFieldPathProperty::FieldClass' has a wrong offset!");
...
static_assert(sizeof(FOptionalProperty) == 0x000070, "Wrong size on FOptionalProperty");
static_assert(offsetof(FOptionalProperty, ValueProperty) == 0x000068, "Member 'FOptionalProperty::ValueProperty' has a wrong offset!");
